...
Client.prototype.setAuth = function (callback) {
  ...
  request.post(authOptions, function (err, res, body) {
    ...
    self.config.serverUrl = 'https://lon.databases.api.rackspacecloud.com/v1.0/'+self.config.auth.accountNumber;//jsonBody.auth.serviceCatalog.cloudServers[0].publicURL;
